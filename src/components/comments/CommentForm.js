        ...
        <form className="commentForm">
            ...
            <fieldset>
                <div className="form-group">
                    ...
                    <textarea placeholder="Enter subject" type="text" id="subject" required autoFocus className="form-control" onChange={handleControlledInputChange} defaultValue={comment.subject} />
                    <label htmlFor="content">Content:</label>  
                    <textarea placeholder="Enter content" type="text" id="content" required autoFocus className="form-control" onChange={handleControlledInputChange} defaultValue={comment.content} />
                </div>
            </fieldset>
